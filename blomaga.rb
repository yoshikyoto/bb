...
bq.setStyle("background-color", "#fafafa")
bq.setStyle("font-family", "monospace")
bq.setStyle("padding",  "10px 15px")
bq.setStyle("margin", "20px")
bq.setStyle("border-radius", "3px")
str.replaceTag!(bq)

pre = Tag.new("pre");
pre.setStyle("border", "1px solid #ccc;")
pre.setStyle("background-color", "#fafafa")
pre.setStyle("padding",  "10px 15px")
pre.setStyle("margin", "20px")
pre.setStyle("border-radius", "3px")
str.replaceTag!(pre)
